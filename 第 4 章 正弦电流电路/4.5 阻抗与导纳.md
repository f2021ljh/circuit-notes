...
例如 $RL$ 串联电路等效为 $GL$ 并联电路，有 $Y=\dfrac{1}{Z}=\dfrac{1}{R+\mathrm{j}\omega L}=\dfrac{R-\mathrm{j}\omega L}{R^2+\omega^2L^2}$。
注意：
- 若把一个 RL 串联电路化为等效的 GL 并联电路，其中 $G$ 不等于 $1/R$，它与原串联电路 RL 和角频率都有关系，等 效电纳 与 角频 率 的 关 系也 不是 成正比的或成反比的 。